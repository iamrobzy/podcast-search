...
def create_index():
    ...
    response = requests.put(ES_URL, headers={"Content-Type": "application/json"}, data=json.dumps(index_config), auth=("elastic", PASSWORD))
    ...
    for dir_inner in dirs_inner:
        ...
        for show in shows:
            ...
            for episode in episodes:
                ...
                meta["word_list"] = " ".join(res["word_list"])  # Ensure it's a string
                meta["text"] = res["text"]
